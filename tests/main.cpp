...
/*   Updated: 2021/03/19 13:23:39 by esoulard         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void) { 
	...
	testsPtr vectorTests[14] = { &test_vector_fillConstr, &test_vector_rangeConstr, &test_vector_copyConstr, &test_vector_opEqual, &test_vector_pushBack_iterate, 
							&test_vector_maxSize, &test_vector_capacity, &test_vector_empty, &test_vector_resize, &test_vector_reserve, &test_vector_oparray, 
							&test_vector_at, &test_vector_front_back, &test_vector_insert,};
