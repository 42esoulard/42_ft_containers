...
/*   Updated: 2021/03/17 15:45:04 by esoulard         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void) { 
	...
	testsPtr vectorTests[6] = { &test_vector_fillConstr, &test_vector_rangeConstr, &test_vector_copyConstr, &test_vector_opEqual, &test_vector_pushBack_iterate, 
							&test_vector_empty, };

	/*    
							 &test_vector_maxSize, &test_vector_front_back,  &test_vector_assign, &test_vector_pushFront, 
